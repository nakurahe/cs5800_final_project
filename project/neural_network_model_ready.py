...
for i, (data_for_train, province_name) in enumerate(zip(other_provinces_data, other_provinces_names)):
    ...
    history = model.fit(data_for_train, data_for_train, epochs=50, batch_size=32, verbose=0, callbacks=[PredictionCallback(bc_data, ax, province_name, data_for_train)])
